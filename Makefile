srcdir = /usr/src/php-ffmpeg
builddir = /usr/src/php-ffmpeg
top_srcdir = /usr/src/php-ffmpeg
top_builddir = /usr/src/php-ffmpeg
EGREP = /bin/grep -E
SED = /bin/sed
CONFIGURE_COMMAND = './configure' '--with-ffmpeg=/usr/local/include/'
CONFIGURE_OPTIONS = '--with-ffmpeg=/usr/local/include/'
...
FFMPEG_SHARED_LIBADD = -Wl,-rpath,/usr/local/lib -L/usr/local/lib -lswscale -Wl,-rpath,/usr/local/lib -L/usr/local/lib -lavformat -Wl,-rpath,/usr/local/lib -L/usr/local/lib -lavcodec
...
prefix = /usr
phplibdir = /usr/src/php-ffmpeg/modules
